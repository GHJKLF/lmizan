...
-- Update get_account_balances to exclude Transfer type from computed balances
...
-- Update get_equity_trend to exclude Transfer type
...
-- Update get_monthly_cash_flow to exclude Transfer type
